...
<head>
    ...
    <title>Studify - Belajar Dimana Saja & Kapan Saja!</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.studify@gmail.com">apps.studify@gmail.com</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
